...
cs_fit = fit(...
    reward_idcs(valid_flags & ~intermediate_flags),...
...
cs_hat = cs_fit(reward_idcs);
us_hat = us_fit(reward_idcs);
...
asymptotic_flags = reward_idcs >= asymptote_idx;
...
% plot DA signal
plot(sp_rpe,time(idcs),da(idcs)/max(dlight_kernel.pdf),...
    'color',highlight_clr);
...
scatter(sp_csresponse,...
    ...
    'linewidth',1);
plot(sp_csresponse,reward_idcs,cs_hat,...
    'color',cs_previous_clr,...
    'linestyle','-',...
    'linewidth',3);
plot(sp_csresponse,reward_idcs,cs_hat,...
...
scatter(sp_usresponse,...
    ...
    'markeredgecolor',cs_intermediate_clr,...
    'linewidth',1);
plot(sp_usresponse,reward_idcs,us_hat,...
    'color',cs_previous_clr,...
    'linestyle','-',...
    'linewidth',3);
plot(sp_usresponse,reward_idcs,us_hat,...
