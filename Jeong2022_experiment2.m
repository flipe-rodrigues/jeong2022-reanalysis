...
xlabel(sp_late,'Time since CS (s)');
...
scatter(sp_test9_initialdynamics,...
    reward_idcs,da_late_early_diff,20,...
    'marker','o',...
    'markerfacealpha',.5,...
    'markerfacecolor','k',...
    'markeredgecolor','k',...
    'linewidth',1);
errorbar(sp_test9_initialdynamics,...
    subtraction_window_length/2,...
    nanmean(da_late_early_diff(1:subtraction_window_length)),...
    nanstd(da_late_early_diff(1:subtraction_window_length)),...
    'color','k',...
    'marker','o',...
    'markersize',15,...
    'markerfacecolor','k',...
