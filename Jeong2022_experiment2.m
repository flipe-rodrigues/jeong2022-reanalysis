...
sp_test9_dynamics = subplot(n_rows,n_cols,4+n_cols*[2,3]);
sp_test9_difference = subplot(n_rows,n_cols,5+n_cols*[2,3]);
...
title(sp_test9_dynamics,'Test IX');
...
xlabel(sp_test9_dynamics,'Reward #');
ylabel(sp_test9_dynamics,{'Normalized DA response',...
    sprintf('(1 = early response averaged over the last %i trials)',...
    normalization_window_length)});
xlabel(sp_test9_difference,...
    sprintf('Trial 1-%i',subtraction_window_length));
ylabel(sp_test9_difference,...
    {'\DeltaNormalized DA response','(early - late)'});
...
plot(sp_test9_dynamics,[1,n_rewards],[0,0],':k',...
    'handlevisibility','off');
plot(sp_test9_dynamics,[1,n_rewards],[1,1],':k',...
    'handlevisibility','off');
scatter(sp_test9_dynamics,...
    reward_idcs,...
