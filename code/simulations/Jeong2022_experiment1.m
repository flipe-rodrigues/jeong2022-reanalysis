...
%     n_rewards = numel(reaction_times);
    ...
    iri_edges = linspace(0,iri_mu*10,iri_n_bins);
...
%     microstimuli = microstimuli / max(sum(microstimuli,2));
    ...
    %% TD learning
%     rwd_mags = 1 - normalize01(mod(0:n_rewards-1,100)) * .0;
...
%         'n',n);
    ...
    scatter(sp_test1,xx(sorted_idcs),da_response(sorted_idcs),10,...
    ...
    scatter(sp_test2,iri,da_response,10,...
