...
%% analysis parameters
trial_period = [0,max(us_delay_set)] + [-2,3] * bg_min_delay;
reward_period = [-2,2];
baseline_period = [-1,0];
roi_period = [0,2];
...
for mm = 1 : n_mice
    ...
    for ee = 1 : n_subexperiments
        ...
        for ss = 1 : n_sessions
            ...
            iti = cs_times - [0;cs_times(1:end-1)+cs_dur_set(ee)];
            ...
            [da_us_baseline_snippets,~] = signal2eventsnippets(...
                time,da,cs_times+us_delay_set(1),baseline_period,dt);
            [da_us_roi_snippets,~] = signal2eventsnippets(...
                time,da,cs_times+us_delay_set(1),roi_period,dt);
