...
n_rows = 4;
n_cols = 3;
sp_state = subplot(n_rows,n_cols,2:n_cols-1+n_cols*0);
sp_iti = subplot(n_rows,n_cols,n_cols);
...
ylabel(sp_usresponse,'DA response at original US time');
...
ylabel(sp_test5,'Cummulative DA response at original US time');
...
plot(sp_test5,...
    1:n_rewards,cumsum(da_us_response),...
    'color','k',...
    'linewidth',1.5);
plot(sp_test5,...
